  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="1"
        className={cn(
          'font-lexend-bold web:scroll-m-20 text-4xl text-foreground tracking-tight lg:text-5xl web:select-text',
          className,
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="2"
        className={cn(
          'font-lexend-bold web:scroll-m-20 text-3xl text-foreground tracking-tight first:mt-0 web:select-text',
          className,
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="3"
        className={cn(
          'font-lexend-bold web:scroll-m-20 text-2xl text-foreground tracking-tight web:select-text',
          className,
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="4"
        className={cn(
          'font-lexend-bold web:scroll-m-20 text-xl text-foreground tracking-tight web:select-text',
          className,
        )}
        ref={ref}
        {...props}
